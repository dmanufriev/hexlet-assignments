...
public class PostsController {
    ...
    public static void create(Context ctx) {
        try {
            ...
            var page = new BuildPostPage(ctx.formParam("name"), ctx.formParam("description"), e.getErrors());
            ctx.render("posts/build.jte", model("page", page));
        }
    }

    public static void index (Context ctx) {
        var postsList = PostRepository.getEntities();
        var page = new PostsPage(postsList);
